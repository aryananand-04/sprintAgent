        ...
        >
          ...
          >
            <div className="flex shrink-0 items-center justify-between px-6 pb-3 pt-5">
              ...
              <button onClick={e => { e.stopPropagation(); setIsExpanded(false) }} className="text-muted-foreground transition-colors hover:text-foreground">
                <X className="h-5 w-5" />
              </button>
            </div>
              ...
              <div className="flex flex-col gap-0.5">
                {headings.map(h => {
                  ...
                  return (
                    ...
                    >
                      <span className="flex-1 overflow-hidden text-ellipsis whitespace-nowrap transition-transform duration-300 group-hover:translate-x-1">{h.text}</span>
                      <motion.div
                        initial={false}
